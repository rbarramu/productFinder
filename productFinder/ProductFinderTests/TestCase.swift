...
class TestCase: XCTestCase {
    ...
    override func wait(for expectations: [XCTestExpectation], timeout seconds: TimeInterval) {
        ...
        let names: [String] = expectations.map(\.description)
