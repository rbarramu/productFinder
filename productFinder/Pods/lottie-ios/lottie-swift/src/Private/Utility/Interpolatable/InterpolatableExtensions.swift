...
extension Vector2D: Interpolatable {
    func interpolateTo(_ to: Vector2D, amount: CGFloat, spatialOutTangent: CGPoint?, spatialInTangent: CGPoint?) -> Vector2D {
        pointValue.interpolateTo(to.pointValue, amount: CGFloat(amount), spatialOutTangent: spatialOutTangent, spatialInTangent: spatialInTangent).vector2dValue
    }
}
...
extension Color: Interpolatable {
    ...
    func interpolateTo(_ to: Color, amount: CGFloat, spatialOutTangent _: CGPoint?, spatialInTangent _: CGPoint?) -> Color {
        Color(r: r.interpolateTo(to.r, amount: amount),
...
extension CurveVertex: Interpolatable {
    func interpolateTo(_ to: CurveVertex, amount: CGFloat, spatialOutTangent _: CGPoint?, spatialInTangent _: CGPoint?) -> CurveVertex {
        CurveVertex(point: point.interpolate(to.point, amount: amount),
