...
private func beCloseTo(
    ...
    public class NMBObjCBeCloseToMatcher: NMBMatcher {
        ...
        @objc public var within: (CDouble) -> NMBObjCBeCloseToMatcher {
            ...
            return { delta in
                NMBObjCBeCloseToMatcher(expected: expected, within: delta)
            }
        }
    }

    public extension NMBMatcher {
        @objc class func beCloseToMatcher(_ expected: NSNumber, within: CDouble) -> NMBObjCBeCloseToMatcher {
            NMBObjCBeCloseToMatcher(expected: expected, within: within)
        }
    }
#endif
